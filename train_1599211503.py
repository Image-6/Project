...
path = 'C:/Users/karan/OneDrive/Desktop/Test/Data/'
...
model.fit(X,Y,validation_split=0.1, epochs=300, batch_size=10)

model.save('C:/Users/karan/OneDrive/Desktop/Test/Output/colorize_autoencoder.model')
